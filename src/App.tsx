  ...
  return (
    <div className="bg-background">
        ...
        >
          <div className="bg-white rounded-full shadow-lg px-2 py-2 relative">
            <div className="flex items-center gap-2 relative">
              {/* Sliding indicator */}
              <motion.div
                className="absolute h-10 bg-black rounded-full w-28"
                initial={false}
                animate={{
                  x: pages.indexOf(currentPage) * (112 + 8)
                }}
              ...
              {pages.map((page) => (
                <button
                  ...
                  className="relative z-10 w-28 h-10 rounded-full transition-colors duration-300 flex items-center justify-center"
      ...
      <div className="flex flex-col items-center gap-20">
        ...
        >
          <motion.div
            animate={{ x: avatarSlideComplete ? -100 : 0 }}
            transition={{
              duration: 1,
              ease: [0.7, 0, 0.2, 1]
            }}
        ...
        {avatarSlideComplete && (
          ...
          >
            <div className="flex items-center">
              <span className="text-5xl tracking-wide">
                {displayText}
              </span>
              <motion.span
      ...
      <div 
        ref={section2Ref}
        className="min-h-screen flex items-center justify-center px-8 -mt-40"
      >
      ...
      <div 
        ref={section3Ref}
        className="min-h-screen flex flex-col items-center justify-center px-8 -mt-40"
      >
        {/* Title */}
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
